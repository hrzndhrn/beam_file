  ...
  [
    ...
    {:attribute, 1, :compile, [:no_auto_import]},
    {
      ...
      :spec,
      {
        ...
        [
          {:type, 33, :fun,
           [{:type, 33, :product, [{:user_type, 33, :num, []}]}, {:user_type, 33, :x, []}]}
        ]
      }
    },
    {
      ...
      :spec,
      {
        ...
        [
          {:type, 27, :fun,
           [{:type, 27, :product, [{:user_type, 27, :num, []}]}, {:user_type, 27, :x, []}]}
        ]
      }
    },
    {
        ...
        [
          {
            ...
            36,
            :fun,
            [{:type, 36, :product, [{:user_type, 36, :num_tuple, []}]}, {:user_type, 36, :x, []}]
          }
        ]
      }
    },
              ...
              [
                {
                  ...
                  0,
                  {:string, 0,
                   [19, 102, 149, 175, 45, 63, 2, 209, 244, 21, 255, 9, 136, 77, 242, 58]},
                  :default,
                  :default
                }
              ]
          ...
          [
            {
              :match,
              38,
              {:tuple, 38, [{:var, 38, :_number_a@1}, {:var, 38, :_number_b@1}]},
              {:var, 38, :_nums@1}
            },
