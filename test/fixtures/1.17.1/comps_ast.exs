        ...
        [
              ...
              [
                do: {
                  ...
                  [
                    ...
                    {
                      {:., [line: 26], [:erlang, :andalso]},
                      [line: 26],
                      [
                        {
                          {:., [line: 26], [:erlang, :is_integer]},
                          [line: 26],
          ...
          },
          {
            ...
            [
              ...
              [
                do: {
                  {:., [{:line, 40}, {:column, 10}], [:erlang, :++]},
                  [{:line, 40}, {:column, 10}],
                  [
                    {:list, [{:version, 0}, {:line, 40}, {:column, 5}], nil},
                    {
                      {:., [{:line, 40}, {:column, 17}], [Enum, :sort]},
                      [{:line, 40}, {:column, 18}],
                      [
                        {
                          :for,
                          ...
                          [
                            ...
                            [into: [], do: {:x, [{:version, 1}, {:line, 40}, {:column, 44}], nil}]
                          ]
                        }
                      ]
                    }
          ...
          },
          {
            ...
            [
              ...
              [
                do: {
                  {:., [{:line, 44}, {:column, 12}], [:erlang, :++]},
                  [{:line, 44}, {:column, 13}],
                  [
                    {:list, [{:version, 0}, {:line, 44}, {:column, 16}], nil},
                    {
                      {:., [{:line, 44}, {:column, 26}], [Enum, :sort]},
                      [{:line, 44}, {:column, 27}],
                      [
                        {
                          :for,
                          ...
                          [
                            ...
                            [into: [], do: {:x, [{:version, 1}, {:line, 44}, {:column, 53}], nil}]
                          ]
                        }
                      ]
                    }
          ...
          },
          {
            ...
            [
              ...
              [
                do: {
                  {:., [{:line, 48}, {:column, 12}], [:erlang, :--]},
                  [{:line, 48}, {:column, 13}],
                  [
                    {:list, [{:version, 0}, {:line, 48}, {:column, 16}], nil},
                    {
                      {:., [{:line, 48}, {:column, 26}], [Enum, :sort]},
                      [{:line, 48}, {:column, 27}],
                      [
                        {
                          :for,
                          ...
                          [
                            ...
                            [into: [], do: {:x, [{:version, 1}, {:line, 48}, {:column, 53}], nil}]
                          ]
                        }
                      ]
                    }
                ...
                do: {
                  ...
                  [
                      ...
                      [
                        {
                          ...
                          [
                            ...
                            {
                              {:., [{:line, 52}, {:column, 32}], [:erlang, :"/="]},
                              [{:line, 52}, {:column, 32}],
                              [{:type, [{:version, 1}, {:line, 52}, {:column, 27}], nil}, :guest]
                            }
                          ]
                        },
                    ...
                    [
                      into: [],
                      do: {
                        {:., [{:line, 53}, {:column, 13}], [String, :upcase]},
                        [{:line, 53}, {:column, 14}],
